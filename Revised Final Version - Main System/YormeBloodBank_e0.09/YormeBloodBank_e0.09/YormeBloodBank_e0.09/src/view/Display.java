...
public interface Display {
    ...
    //DEV APP MESSAGE
    String ADMIN_WRONG_CREDENTIALS = "Wrong Developer user or password";
    
    
    
    // ADMIN MESSAGES
    String ADMIN_ONLY = "Only Admin accounts can use this feature";
    String LOGIN_AS_ADMIN = "Do you want to log in an Admin account?";
    String CANNOT_ADD = "Cannot add more Administrators. Only 5 Admins Allowed";
    ...
    String PROPER_FORMAT = "Proper date format not followed (YYYY/MM/DD), please try again.";
    ...
    String ZERO_INPUT = "Shelf life cannot be equal to zero or below zero";
    ...
    String QTY_NUM = "Quantity must not have a letter";
    ...
    String BT_EXIST = "Donor Already Exists, please try again";
    
    //PackType
    String PT_ID_DELETE = "Deleted Pack Type ID: ";
    String PT_DELETE = "Pack Type Deleted";
    String PT_UPDATED = "Pack Type Updated";
